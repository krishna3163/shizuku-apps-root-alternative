...
| **[Android-Personal-Agent](https://github.com/lzh2034855417-beep/Android-Personal-Agent)** | An open-source Agent Framework for Android. Perceives device state, analyzes system health, and executes tasks via LLM Tool Calling. Supports API / Shizuku / Root triple-layer capabilities. | See project | [GitHub](https://github.com/lzh2034855417-beep/Android-Personal-Agent) |
| **[AndroidHarness](https://github.com/Sanuu7/AndroidHarness)** | A Native  AI Coding Agent Harness app for Android | See project | [GitHub](https://github.com/Sanuu7/AndroidHarness) |
...
| **[awesome-android-app-repositories](https://github.com/krishna3163/awesome-android-app-repositories)** | ⚡ Curated & continuously updated catalog of 1,600+ open-source Android apps, GitHub repositories, developer tools, AI platforms, and utilities automatically synchronized from Telegram. | See project | [GitHub](https://github.com/krishna3163/awesome-android-app-repositories) |
...
| **[FechaTudoPlus](https://github.com/odorizzioficial/FechaTudoPlus)** | Gerenciador de apps em segundo plano para Android. Encerra, bloqueia, protege e agenda limpezas — via Shizuku, sem root. | See project | [GitHub](https://github.com/odorizzioficial/FechaTudoPlus) |
| **[FlowBridge](https://github.com/catgarret/FlowBridge)** | Native macOS bridge for Galaxy phones: DeX and screen mirroring, app windows, wireless ADB, notifications, calls, messages, and file transfer. Galaxy를 Mac에서 연결·미러링하는 오픈소스 도구. | See project | [GitHub](https://github.com/catgarret/FlowBridge) |
| **[Game-Booster](https://github.com/mizanbinb/Game-Booster)** | Boost gaming performance with one-click optimization, unlock FPS, and reduce lag on Windows 10/11. | See project | [GitHub](https://github.com/mizanbinb/Game-Booster) |
...
| **[KillMyApps](https://github.com/dedeadend/KillMyApps)** | Android app killer using Root & Shizuku to save battery, boost performance and enhance privacy. | See project | [GitHub](https://github.com/dedeadend/KillMyApps) |
| **[LocalAndroidStore](https://github.com/SysAdminDoc/LocalAndroidStore)** | Your private Android app catalog for signed GitHub and F-Droid releases, with publisher pinning, safe updates, and a Wear OS companion. | See project | [GitHub](https://github.com/SysAdminDoc/LocalAndroidStore) |
...
| **[Shizako](https://github.com/xm1437/Shizako)** | 猫耳看板娘版的 Shizuku \| A catgirl-mascot edition of Shizuku — use privileged Android APIs without root. Official Shizuku-API apps connect without code changes. Apache-2.0 | See project | [GitHub](https://github.com/xm1437/Shizako) |
| **[ShizuCoreFetch](https://github.com/elhizazi1/ShizuCoreFetch)** | An advanced centralized platform for fetching and managing applications requiring core permissions. | See project | [GitHub](https://github.com/elhizazi1/ShizuCoreFetch) |
...
| **Morphe AutoBuilds** | RookieEnough | `latest` | 2026-09-07 | [⬇️ Download](https://github.com/krishna3163/best_shizuku_apps_for_android_no_root/releases/tag/morphe-autobuilds-latest) | [GitHub](https://github.com/RookieEnough/Morphe-AutoBuilds) |
...
| **Obtainium** | ImranR98 | `v1.6.15` | 2026-09-07 | [⬇️ Download](https://github.com/krishna3163/best_shizuku_apps_for_android_no_root/releases/tag/obtainium-v1.6.15) | [GitHub](https://github.com/ImranR98/Obtainium) |
