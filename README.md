...
| **[adb-install-script-v2](https://github.com/Praashon/adb-install-script-v2)** | Desktop app for managing Android devices from Windows. Install APKs via drag and drop, mirror and control your screen with built-in SCRCPY, pair devices wirelessly, review APK permissions before install, and monitor live logcat output. | See project | [GitHub](https://github.com/Praashon/adb-install-script-v2) |
| **[adb-studio](https://github.com/Zaphkiel-Ivanovna/adb-studio)** | A beautiful, native macOS app for managing Android devices via ADB. Wireless debugging, screenshots, port forwarding, and more. | See project | [GitHub](https://github.com/Zaphkiel-Ivanovna/adb-studio) |
| **[ADBeesh](https://github.com/IndiTheo/ADBeesh)** | ADBeesh is a library that allows an Android app to perform ADB pairing and establish a local ADB connection to the device via Wireless Debugging (mirrored from GitLab). Development: https://gitlab.com/IndiDevs/adbeesh | See project | [GitHub](https://github.com/IndiTheo/ADBeesh) |
| **[AdbWirelessToolkitGUI](https://github.com/setzer333/AdbWirelessToolkitGUI)** | Herramienta basada en ADB con interfaz grafica para transferir apps a dispositivos android usando la depuracion USB y la depuracion inalambrica.  | See project | [GitHub](https://github.com/setzer333/AdbWirelessToolkitGUI) |
| **[Ali-omrani-hotspot-limit-data-2](https://github.com/ali-omrani-1/Ali-omrani-hotspot-limit-data-2)** | Ali Omrani Hotspot Limit is an advanced tool to strictly manage Wi-Fi tethering data on Android 16 and custom ROMs. It isolates hotspot traffic (ap0) for 100% accuracy, ignoring host usage. Featuring a floating monitor UI, it guarantees auto-shutdown upon reaching limits via Root (KernelSU), Shizuku, or an Accessibility auto-clicker fallback. | See project | [GitHub](https://github.com/ali-omrani-1/Ali-omrani-hotspot-limit-data-2) |
| **[Android-Dex](https://github.com/Shrey113/Android-Dex)** | Universal Samsung DeX alternative for all Android devices. Run Android apps on Windows, Linux & macOS with resizable windows, advanced FPS gaming controls, and high-performance wireless ADB mirroring. | See project | [GitHub](https://github.com/Shrey113/Android-Dex) |
| **[android-doctor-app](https://github.com/knowamit/android-doctor-app)** | Android Doctor companion app — diagnose why your phone is slow, directly on device. Kotlin + Jetpack Compose + MVVM + Clean Architecture. | See project | [GitHub](https://github.com/knowamit/android-doctor-app) |
| **[android-intelligence](https://github.com/OutrageousStorm/android-intelligence)** | 🤖 Android Intelligence — Open-source Android tools by Tom. No root. No BS. | See project | [GitHub](https://github.com/OutrageousStorm/android-intelligence) |
| **[Android-Universal-Debloat](https://github.com/myruldev/Android-Universal-Debloat)** | 🤖 Tool Debloat Universal untuk 24+ merek HP (Samsung, Oppo, Vivo, Realme, dll) TANPA ROOT. Fitur: Mode Simulasi, Auto-Backup, & Database aplikasi bawaan terlengkap. | See project | [GitHub](https://github.com/myruldev/Android-Universal-Debloat) |
| **[anytool](https://github.com/838288383838383/anytool)** | Android multi-tool powered by Shizuku/Dhizuku — debloat, tweak, debug, Linux sandbox terminal, and more | See project | [GitHub](https://github.com/838288383838383/anytool) |
| **[app-installer-offline](https://github.com/geetanjalinuuadia-lgtm/app-installer-offline)** | Offline App Installer for Android with Material 3 Expressive UI and authorized Wireless ADB support. | See project | [GitHub](https://github.com/geetanjalinuuadia-lgtm/app-installer-offline) |
| **[AppManagerNG](https://github.com/SysAdminDoc/AppManagerNG)** | Inspect, debloat, back up, freeze, and control Android apps from one open-source package manager. Works without root, with Shizuku, ADB, or root when needed. | See project | [GitHub](https://github.com/SysAdminDoc/AppManagerNG) |
| **[AppOpsNext](https://github.com/1zumiii/AppOpsNext)** | Modern Android 15+ AppOps manager powered by Shizuku. | See project | [GitHub](https://github.com/1zumiii/AppOpsNext) |
| **[awesome-android-app-repositories](https://github.com/bensonsquiggly4244/awesome-android-app-repositories)** | Discover curated open-source Android apps, tools, and repositories from Telegram—updated continuously for developers and power users. | See project | [GitHub](https://github.com/bensonsquiggly4244/awesome-android-app-repositories) |
| **[best-root-apps-for-android](https://github.com/krishna3163/best-root-apps-for-android)** | Curated directory of Android root apps, Magisk, KernelSU, LSPosed modules, system tools, privacy utilities, and no-root Shizuku apps. | See project | [GitHub](https://github.com/krishna3163/best-root-apps-for-android) |
| **[BetterAIChat](https://github.com/Verlintas/BetterAIChat)** | Native Android AI agent: use your own API keys (OpenAI/Anthropic/Gemini), opencode-style modes, device tools, Shizuku shell, screen analysis, web search, custom Skills, voice assistant | See project | [GitHub](https://github.com/Verlintas/BetterAIChat) |
| **[BloatFree-Android](https://github.com/DuminAndrew/BloatFree-Android)** | Debloat Android without root using Shizuku. Jetpack Compose, MVVM. Safely disable/remove bloatware (disable-user by default). | See project | [GitHub](https://github.com/DuminAndrew/BloatFree-Android) |
| **[bubble-notice-android](https://github.com/GraceThings/bubble-notice-android)** | A lightweight bubble notice tool for android phones, no "Root/Shizuku" required. | See project | [GitHub](https://github.com/GraceThings/bubble-notice-android) |
| **[Canta](https://github.com/Sidhsksjsjsh/Canta)** | Uninstall any Android app without root (with power of Shizuku). Debloat your device as you wish, no PC required. | See project | [GitHub](https://github.com/Sidhsksjsjsh/Canta) |
| **[Canta-debloater](https://github.com/johakovi/Canta-debloater)** | Ready to use selected list to debloat Samsung OneUI 8.5. Works also on other android systems. | See project | [GitHub](https://github.com/johakovi/Canta-debloater) |
| **[DarQ-Reborn](https://github.com/Arora-Sir/DarQ-Reborn)** | Selectable per-app Force Dark theme enabler for Android 10+ using Shizuku or Root. Features an LSPosed/Xposed module to bypass app-level dark mode blocks, automated sunrise/sunset scheduling, and automation broadcasts (Tasker/MacroDroid). | See project | [GitHub](https://github.com/Arora-Sir/DarQ-Reborn) |
| **[debloat-samsung-ADB-shizuku](https://github.com/Achno/debloat-samsung-ADB-shizuku)** |   A list of bloatware packages that samsung phones have with instructions to remove them | See project | [GitHub](https://github.com/Achno/debloat-samsung-ADB-shizuku) |
| **[Debloater-next](https://github.com/Dev97633/Debloater-next)** | A safe, open-source Android debloater using Shizuku — no root required. | See project | [GitHub](https://github.com/Dev97633/Debloater-next) |
| **[droid-desk](https://github.com/lovelts/droid-desk)** | DroidDesk is a macOS app for connecting to and controlling Android devices via USB or Wi-Fi. It supports device discovery, wireless ADB pairing, screen mirroring, and basic navigation controls. | See project | [GitHub](https://github.com/lovelts/droid-desk) |
| **[DX-Manager](https://github.com/maze-mei/DX-Manager)** | Windows manager for Samsung DeX (dex for pc, 삼성 덱스) virtual displays and scrcpy app windows over USB or wireless ADB. | See project | [GitHub](https://github.com/maze-mei/DX-Manager) |
...
| **[Gamaspace](https://github.com/coco0081/Gamaspace)** | Game optimization app with Shizuku support - RAM, CPU, GPU, Battery optimization and Game Launcher for Android 8-16 | See project | [GitHub](https://github.com/coco0081/Gamaspace) |
| **[Genshin-SpikeGuard](https://github.com/qw2548er/Genshin-SpikeGuard)** | Android GPU spike protection tool for Genshin Impact - decoupled architecture with Root/Shizuku support | See project | [GitHub](https://github.com/qw2548er/Genshin-SpikeGuard) |
| **[harbor](https://github.com/Stem0794/harbor)** | Privacy-focused Android work-profile manager using standard DevicePolicyManager APIs, with optional Shizuku tools. | See project | [GitHub](https://github.com/Stem0794/harbor) |
...
| **[helix-debloater](https://github.com/darlantls/helix-debloater)** | Disable and remove pre-installed apps (bloatware) from your Android without root, via Shizuku. Tested on the LG K41S. | See project | [GitHub](https://github.com/darlantls/helix-debloater) |
| **[hyperosunfcker](https://github.com/Enki013/hyperosunfcker)** | HyperOS Optimizer Android app (Shizuku-based HyperOS tuning and debloat) | See project | [GitHub](https://github.com/Enki013/hyperosunfcker) |
...
| **[jettwado6-sketch.github.io](https://github.com/jettwado6-sketch/jettwado6-sketch.github.io)** | Discover, verify, and track Android apps powered by Shizuku with this auto-updated, curated directory. | See project | [GitHub](https://github.com/jettwado6-sketch/jettwado6-sketch.github.io) |
| **[magicdesk](https://github.com/mekhontsev/magicdesk)** | Open-source Android 15+ workstation with native windows, external displays, desktop tools, automation, and first-class multi-window Termux integration. | See project | [GitHub](https://github.com/mekhontsev/magicdesk) |
| **[MirrorBridge](https://github.com/jihtsan/MirrorBridge)** | Native macOS app for wireless Android screen mirroring via ADB and scrcpy | See project | [GitHub](https://github.com/jihtsan/MirrorBridge) |
...
| **[portal-toolkit](https://github.com/jurax-sys/portal-toolkit)** | Android app for managing Meta/Facebook Portal devices over USB and Wireless ADB. | See project | [GitHub](https://github.com/jurax-sys/portal-toolkit) |
| **[shizuku-ftp](https://github.com/rD227/shizuku-ftp)** | FTP server app for android with using Shizuku | See project | [GitHub](https://github.com/rD227/shizuku-ftp) |
| **[shizuku-modules](https://github.com/jettwado6-sketch/shizuku-modules)** | Discover and track Android apps powered by Shizuku, updated daily from GitHub. | See project | [GitHub](https://github.com/jettwado6-sketch/shizuku-modules) |
| **[ShizukuPlus](https://github.com/thejaustin/ShizukuPlus)** | An enhanced fork of Shizuku — adds Root/ADB/Dhizuku unification, a Plus API suite, and OneUI/Android 16+ compatibility fixes, while staying fully compatible with existing Shizuku apps. | See project | [GitHub](https://github.com/thejaustin/ShizukuPlus) |
| **[system-app-remover-sui](https://github.com/hiradomidvar-beep/system-app-remover-sui)** | Universal Android system app disabler powered by Shizuku & Root — safely debloat any device with risk-level warnings before disabling critical system apps. | See project | [GitHub](https://github.com/hiradomidvar-beep/system-app-remover-sui) |
| **[TellyEcp](https://github.com/saappleg/TellyEcp)** | Standalone Telly ECP server for Android TV with Shizuku app control and redirects | See project | [GitHub](https://github.com/saappleg/TellyEcp) |
| **[TvToolsPro](https://github.com/deekshith0509/TvToolsPro)** | Open-source Android TV / STB control tool over wireless ADB (remote, apps, files, permissions, media, terminal). | See project | [GitHub](https://github.com/deekshith0509/TvToolsPro) |
| **[wADB](https://github.com/c5inco/wADB)** | A tiny macOS menu-bar app that keeps paired Android phones available for wireless debugging. | See project | [GitHub](https://github.com/c5inco/wADB) |
| **[WuWa-Tool-Android](https://github.com/k4wai1/WuWa-Tool-Android)** | An app to organize and apply Wuthering Waves graphics configs safely using Shizuku. | See project | [GitHub](https://github.com/k4wai1/WuWa-Tool-Android) |
| **[zafiro](https://github.com/niki914/zafiro)** | BYOK agent tool built with Material 3 Expressive. Control your device, execute Shell and Python natively with Shizuku or Root, supporting Skills and MCP. | See project | [GitHub](https://github.com/niki914/zafiro) |
...
| **de1984** | dorumrr | `v2.7.5` | 2026-09-04 | [⬇️ Download](https://github.com/krishna3163/best_shizuku_apps_for_android_no_root/releases/tag/de1984-v2.7.5) | [GitHub](https://github.com/dorumrr/de1984) |
...
| **Dragon-Launcher** | Elnix90 | `4.1.3` | 2026-09-05 | [⬇️ Download](https://github.com/krishna3163/best_shizuku_apps_for_android_no_root/releases/tag/dragon-launcher-4.1.3) | [GitHub](https://github.com/Elnix90/Dragon-Launcher) |
| **Droid-ify** | Droid-ify | `v0.7.7` | 2026-09-04 | [⬇️ Download](https://github.com/krishna3163/best_shizuku_apps_for_android_no_root/releases/tag/droid-ify-v0.7.7) | [GitHub](https://github.com/Droid-ify/client) |
...
| **Obtainium** | ImranR98 | `v1.6.14` | 2026-08-29 | [⬇️ Download](https://github.com/krishna3163/best_shizuku_apps_for_android_no_root/releases/tag/obtainium-v1.6.14) | [GitHub](https://github.com/ImranR98/Obtainium) |
...
| **SDMaid-SE** | d4rken-org | `v2.0.4-rc0` | 2026-08-26 | [⬇️ Download](https://github.com/krishna3163/best_shizuku_apps_for_android_no_root/releases/tag/sdmaid-se-v2.0.4-rc0) | [GitHub](https://github.com/d4rken-org/sdmaid-se) |
...
| **ShizuWall** | AhmetCanArslan | `v4.6.3` | 2026-08-27 | [⬇️ Download](https://github.com/krishna3163/best_shizuku_apps_for_android_no_root/releases/tag/shizuwall-v4.6.3) | [GitHub](https://github.com/AhmetCanArslan/ShizuWall) |
